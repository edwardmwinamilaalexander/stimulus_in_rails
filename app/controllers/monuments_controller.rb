class MonumentsController < ApplicationController
  ...
  def index
    ...
    @monument = Monument.new  # ← Add this line
  end
  ...
  def destroy
    @monument.destroy!
    redirect_to monuments_path, notice: "Monument was successfully destroyed.", status: :see_other
  end

  private
    # Use callbacks to share common setup or constraints between actions.
    def set_monument
      @monument = Monument.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def monument_params
      params.expect(monument: [ :name, :address, :opening_date ])
    end
end
